...
test_bp = Blueprint('test_bp', __name__, url_prefix='/category')
...
@test_bp.route('/<int:id>/subcategory', methods=['POST'])
@token_required
...
@test_bp.route('/<int:id>/updateState/<int:state>', methods=['GET'])
@token_required
